...
////finish the function below to cement the separation of making the note objects and putting them on the staff
//// see putNotesBackOnSystems, below
// function generateLineSimpler(rhythms_nested, steps_nested, key, octave, beatsPer, stave, hand, startMeasure, barsPerLine, major_or_minor){
//     if (hand === 'r') {
//         var clef = 'treble';
//     }
//     else {
//         var clef = 'bass';
//     }
//     notes = makeLine(rhythms_nested, steps_nested, key, octave, clef, major_or_minor);
//     putNotesBackOnSystems(notes, hand, key, )
// }
